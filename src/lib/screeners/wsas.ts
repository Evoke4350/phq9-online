...
const bands: SeverityBand[] = [
  {
    min: 0,
    max: 9,
    labelKey: 'wsas_subclinical',
    severity: 'mild',
    actionKey: 'wsas_action_subclinical'
  },
  {
    min: 10,
    max: 19,
    labelKey: 'wsas_significant',
    severity: 'moderate',
    actionKey: 'wsas_action_significant'
  },
  { min: 20, max: 40, labelKey: 'wsas_severe', severity: 'severe', actionKey: 'wsas_action_severe' }
];
const noBand: SeverityBand = {
  min: 0,
  max: 0,
  labelKey: 'wsas_none',
  severity: 'none',
  actionKey: 'wsas_action_none'
};
